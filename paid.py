...
def reg():
    ...
    time.sleep(1)
    try:
        to = open("/sdcard/.public.txt", "r").read()
    ...
    if to in r:
        ...
        os.system("xdg-open https://wa.me/+01741747794")
        reg()
def reg2():
    os.system("clear")
    print(logo)
    ...
    s = open('/sdcard/.public.txt', 'w')
    s.write(id)
    s.close()
    ids = open('/sdcard/.public.txt', 'r').read()
    print(" Your key: "+ids)
    print("")
    print("")
